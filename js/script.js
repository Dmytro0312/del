...
function createCarts(item) {
	...
	<div class="products-main__item item-products-main wow animate__bounceIn" id="${id}" data-products="${products}">
...
function giveAuthorizationForm(event) {
	...
	buttonOpenAuthorization.insertAdjacentHTML("afterbegin",
		`
	<div><img src="img/header/header__icon-user.svg" alt="icon"></div>
	<div>Выйти</div>
	`);
	buttonOpenAuthorization.lastElementChild.style.textDecoration = "underline";
...
function getMainItems(itemMainImg, itemMainTitle, itemMainText, ItemMainPrice, itemMainId) {
	mainItemsContainer.lastElementChild.insertAdjacentHTML(
		"beforeend",
		`
		<div class="main__item item-main" id="${itemMainId}">
